...
#
# python3 densenet.py densenet.cu densenet.schedule.json densenet.graph.json densenet.params
#####################################################
...
file_path_dir = os.path.dirname(os.path.abspath(__file__)) + '/densenet'
if not os.path.exists(file_path_dir):
    os.mkdir(file_path_dir)
device_source_file = open("densenet/"+sys.argv[1], "w")  # cu
raw_schedule_file = open("densenet/"+sys.argv[2], "w")  # json
graph_json_file = open("densenet/"+sys.argv[3], "w")  # json
