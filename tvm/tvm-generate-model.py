...
device_source_file = open("data/"+sys.argv[1], "w")  # cu
raw_schedule_file = open("data/"+sys.argv[2], "w")  # json
graph_json_file = open("data/"+sys.argv[3], "w")  # json
param_file = open("data/"+sys.argv[4], "w+b")  # params
